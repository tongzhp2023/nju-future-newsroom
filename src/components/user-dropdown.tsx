  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="w-9 h-9 rounded-full bg-[var(--surface-active)] border border-[var(--border)] flex items-center justify-center text-sm font-bold text-[var(--foreground)] hover:ring-2 hover:ring-[var(--border)] transition"
        title={displayName}
        aria-expanded={open}
        aria-haspopup="menu"
        aria-label="用户菜单"
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-44 bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl shadow-lg overflow-hidden z-50" role="menu">
